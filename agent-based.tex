...
%\label{subsec:abmodelapp}

%We compared our results from the agent-based model to the differential models and analyzed how the credibility, memorability, and novelty affected the steady states (or final distributions) of the populations. Additionally, we compared it to a realistic network to examine if this alters the spread of the rumor. Finally, we incorporated demographic and characteristic information about the network and the rumor (a feature vector).
...
\begin{table}[ht]
\begin{center}
%\begin{tabular}{l c | l | p{6cm} | p{6cm} | l |}
%	&\multicolumn{5}{c}{\textbf{Poster State}}\\ \cline{3-6}
%	 \multicolumn{1}{c}{} &&I&S&T&K\\ \cline{2-6}
%	 \multicolumn{1}{c|}{\multirow{4}{*}{\rotatebox[origin=c]{90}{\textbf{Reader State}}}}& \multicolumn{1}{c|}{I} & N/A & becomes S with prob. of $ c = 0.8 $ or T with prob. of $ (1-c) = 0.2 $ & N/A & N/A  \\[1ex] \cline{2-6}
%	\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{S} & N/A & becomes T with prob. of $ \alpha_1 = 0.01 $ & becomes T with prob. of $ \alpha_2 = 0.02 $ & N/A \\[1ex] \cline{2-6}
%	\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{T} & N/A & N/A & N/A & N/A\\[1ex] \cline{2-6}
%	\multicolumn{1}{c|}{} & \multicolumn{1}{c|}{K} & N/A & becomes T with prob. of $ \alpha_1 = 0.01 $ & N/A & N/A \\ [1ex] \cline{2-6}
